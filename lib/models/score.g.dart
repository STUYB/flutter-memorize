...
Score _scoreDeserialize(
  ...
  final object = Score(
    score: reader.readLong(offsets[0]),
...
extension ScoreQueryFilter on QueryBuilder<Score, Score, QFilterCondition> {
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameEqualTo(
    String value, {
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'username',
        value: '',
  ...
  QueryBuilder<Score, Score, QAfterFilterCondition> usernameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'username',
        value: '',
...
extension ScoreQuerySortBy on QueryBuilder<Score, Score, QSortBy> {
  ...
  QueryBuilder<Score, Score, QAfterSortBy> sortByUsername() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'username', Sort.asc);
    });
  }

  QueryBuilder<Score, Score, QAfterSortBy> sortByUsernameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ScoreQuerySortThenBy on QueryBuilder<Score, Score, QSortThenBy> {
  ...
  QueryBuilder<Score, Score, QAfterSortBy> thenByUsername() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'username', Sort.asc);
    });
  }

  QueryBuilder<Score, Score, QAfterSortBy> thenByUsernameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'username', Sort.desc);
    });
  }
...
extension ScoreQueryWhereDistinct on QueryBuilder<Score, Score, QDistinct> {
  ...
  QueryBuilder<Score, Score, QDistinct> distinctByUsername(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ScoreQueryProperty on QueryBuilder<Score, Score, QQueryProperty> {
  ...
  QueryBuilder<Score, String, QQueryOperations> usernameProperty() {
    return QueryBuilder.apply(this, (query) {
